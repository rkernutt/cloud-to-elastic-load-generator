...
describe("All AZURE_TRACE_GENERATORS — structural invariants", () => {
  for (const [name, gen] of Object.entries(AZURE_TRACE_GENERATORS)) {
...
describe("Azure workflow generators — error branch at er=1", () => {
