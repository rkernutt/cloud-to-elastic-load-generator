...
export function generateCognitiveServicesLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "throttle") {
    ...
    return {
      ...
      event: { outcome: "failure", duration: randInt(1e6, 2e8) },
  ...
  if (variant === "modelDeploy") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(2e11, 2e13) },
      message: isErr
...
export function generateMachineLearningLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "datastore") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(4e7, 2e9) },
      message: isErr
  ...
  if (variant === "workspaceAdmin") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(1e8, 4e10) },
      message: isErr
  ...
  return {
    ...
    event: { outcome: isErr ? "failure" : "success", duration: randInt(9e8, 3e11) },
    message: isErr
...
export function generateAiSearchLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "synonymMap") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(1e7, 3e9) },
      message: isErr
  ...
  return {
    ...
    event: { outcome: isErr ? "failure" : "success", duration: randInt(4e10, 2e13) },
    message: isErr
...
export function generateBotServiceLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "webhook") {
    const docErr = aiSecurityPickError(isErr);
    const props = {
      callbackUrlHost: rand(["botservice.azurewebsites.net", "api.enterprise.contoso"]),
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(2e9, 3e11) },
      message: isErr
  ...
  return {
    ...
    event: { outcome: isErr ? "failure" : "success", duration: randInt(1e10, 3e13) },
    message: isErr
...
export function generateVisionLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "moderation") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(1e6, 2e10) },
      message: isErr
  ...
  return {
    ...
    event: { outcome: isErr ? "failure" : "success", duration: randInt(1e9, 2e11) },
    message: isErr
...
export function generateTranslatorLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "glossary") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(2e10, 2e12) },
      message: isErr
  ...
  if (variant === "detect") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(1e7, 4e11) },
      message: isErr
  ...
  if (variant === "rbac") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(3e8, 2e10) },
      message: isErr
  ...
  return {
    ...
    event: { outcome: isErr ? "failure" : "success", duration: randInt(1e10, 2e13) },
    message: isErr
...
export function generateManagedIdentityLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "revoke") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(1e11, 2e13) },
      message: isErr
  ...
  return {
    ...
    event: { outcome: isErr ? "failure" : "success", duration: randInt(9e11, 2e13) },
    message: isErr
...
export function generateDefenderForCloudLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "ingestion") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(2e13, 4e13) },
      message: isErr
  ...
  return {
    ...
    event: { outcome: isErr ? "failure" : "success", duration: randInt(2e12, 2e14) },
    message: isErr
...
export function generateSentinelLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "connector") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(2e13, 2e14) },
      message: isErr
  ...
  return {
    ...
    event: { outcome: isErr ? "failure" : "success", duration: randInt(1e12, 2e13) },
    message: isErr
...
export function generateAttestationLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "rbacAssign") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(1e13, 2e13) },
      message: isErr
  ...
  if (variant === "nonceReplay") {
    ...
    return {
      ...
      event: { outcome: "failure", duration: randInt(9e11, 2e13) },
...
export function generateConfidentialLedgerLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "rbacAssignment") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(1e13, 3e13) },
      message: isErr
  ...
  if (variant === "drFailover") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(2e14, 4e14) },
      message: isErr
  ...
  return {
    ...
    event: { outcome: isErr ? "failure" : "success", duration: randInt(1e13, 2e14) },
    message: isErr
...
export function generateActivityLogLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "delegatedAdmin") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(8e13, 2e14) },
      message: isErr
  ...
  return {
    ...
    event: { outcome: isErr ? "failure" : "success", duration: randInt(2e14, 3e14) },
    message: isErr
...
export function generatePolicyLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "denyAudit") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(2e12, 2e13) },
      message: isErr
...
export function generateAdvisorLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "export") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(2e14, 2e14) },
      message: isErr
...
export function generateCostManagementLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "reservation") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(4e14, 4e14) },
      message: isErr
  ...
  if (variant === "priceSheet") {
    ...
    return {
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(9e13, 2e14) },
      message: isErr
...
export function generateBlueprintsLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "rbac") {
    const docErr = aiSecurityPickError(isErr);
    const props = {
      contributorPrincipals: randInt(1, 12),
      lockLevel: rand(["CanNotDelete", "ReadOnly"]),
      statusCode: isErr ? rand([401, 403]) : 204,
      correlationId,
    };
    const propsForDoc = mergeAiSecurityArmProps(isErr, true, props, docErr);
    return {
      ...
      time,
      resourceId,
      operationName: "Microsoft.Blueprint/blueprintAssignments/locks/write",
      category: "AccessControl",
      resultType: isErr ? "Failure" : "Success",
      resultSignature: String(props.statusCode),
      callerIpAddress: callerIp,
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(1e13, 2e13) },
      message: isErr
        ? `Blueprint lock apply failed (${props.statusCode})`
        : `Assigned ${props.contributorPrincipals} principals with ${props.lockLevel}`,
      ...(docErr ? { error: docErr } : {}),
    };
  }
  ...
  if (variant === "delegated") {
    const docErr = aiSecurityPickError(isErr);
    const props = {
      managedByTenantId: randUUID(),
      assignmentScope: `/subscriptions/${subscription.id}`,
      status: isErr ? "Revoked" : "Active",
      correlationId,
    };
    const propsForDoc = mergeAiSecurityArmProps(isErr, true, props, docErr);
    return {
      ...
      time,
      resourceId,
      operationName: "Microsoft.Blueprint/blueprintAssignments/delegatedWrite",
      category: "DelegatedMgmt",
      resultType: isErr ? "Failure" : "Success",
      resultSignature: props.status,
      callerIpAddress: callerIp,
      correlationId,
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(2e14, 2e14) },
      message: isErr
        ? `Delegated blueprint path ${props.status}`
        : `Mgmt tenant ${props.managedByTenantId.slice(0, 8)} active on ${props.assignmentScope}`,
      ...(docErr ? { error: docErr } : {}),
    };
  }

  if (variant === "artifactRollback") {
    const docErr = aiSecurityPickError(isErr);
    const props = {
      artifactName: `art-${randId(5)}`,
      fromVersion: `v${randInt(1, 4)}`,
      toVersion: `v${randInt(1, 4)}`,
      rollbackState: isErr ? "Failed" : "Succeeded",
      correlationId,
    };
    const propsForDoc = mergeAiSecurityArmProps(isErr, true, props, docErr);
    return {
      ...
      time,
      resourceId,
      operationName: "Microsoft.Blueprint/artifacts/rollback",
      category: "ArtifactOps",
      resultType: isErr ? "Failure" : "Success",
      resultSignature: props.rollbackState,
      callerIpAddress: callerIp,
      correlationId,
      level: isErr ? "Error" : "Information",
      properties: propsForDoc,
      ...
      event: { outcome: isErr ? "failure" : "success", duration: randInt(2e14, 2e14) },
      message: isErr
        ? `Artifact ${props.artifactName} rollback failed`
        : `Rolled ${props.artifactName} ${props.fromVersion} -> ${props.toVersion}`,
      ...(docErr ? { error: docErr } : {}),
    };
  }
  ...
  const docErr = aiSecurityPickError(isErr);
  const props = {
    historyEntries: isErr ? 0 : randInt(4, 80),
    publishedBy: rand(["platform-team", "finops"]),
    auditTrailHash: randId(16),
    statusCode: isErr ? rand([500, 503]) : 200,
    correlationId,
  };
  const propsForDoc = mergeAiSecurityArmProps(isErr, false, props, docErr);
  return {
    ...
    time,
    resourceId,
    operationName: "Microsoft.Blueprint/blueprintAssignments/history/read",
    ...
    event: { outcome: isErr ? "failure" : "success", duration: randInt(1e13, 2e13) },
    message: isErr
      ? `Blueprint history pull failed (${props.statusCode})`
      : `${props.historyEntries} revisions from ${props.publishedBy}`,
    ...(docErr ? { error: docErr } : {}),
  };
}
