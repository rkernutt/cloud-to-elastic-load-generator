...
export function generateRelayLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "sender") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e5, 2e8),
        String("Microsoft.Relay/namespaces/hybridConnections/sender/write"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "throughput") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e6, 4e8),
        String("Microsoft.Relay/namespaces/hybridConnections/metrics/throttle"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "health") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e5, 9e7),
        String("Microsoft.Relay/namespaces/health/read"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 3e9),
      String("Microsoft.Relay/namespaces/write"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
...
export function generateIotCentralLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "telemetry") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e6, 3e8),
        String("Microsoft.IoTCentral/iotApps/telemetry/ingress"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "rule") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e6, 5e8),
        String("Microsoft.IoTCentral/iotApps/rules/evaluate"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "export") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e8, 4e10),
        String("Microsoft.IoTCentral/iotApps/dataExport/write"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "deviceCommand") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e7, 5e8),
        String("Microsoft.IoTCentral/iotApps/devices/commands/send"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(2e7, 6e8),
      String("Microsoft.IoTCentral/iotApps/dashboards/read"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateDeviceProvisioningLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "enrollment") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e6, 4e8),
        String("Microsoft.Devices/provisioningServices/enrollmentGroups/attestation"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "register") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e6, 6e8),
        String("Microsoft.Devices/provisioningServices/registrations/register"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "reenrollment") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e6, 5e8),
        String("Microsoft.Devices/provisioningServices/registrations/renew"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "allocation") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e7, 8e8),
        String("Microsoft.Devices/provisioningServices/allocationPolicy/evaluate"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "policy") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e7, 6e8),
        String("Microsoft.Devices/provisioningServices/policies/run"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 4e9),
      String("Microsoft.Devices/provisioningServices/write"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
...
export function generateMediaServicesLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "stream") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e6, 5e8),
        String("Microsoft.Media/mediaServices/streamingEndpoints/request"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "asset") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e8, 2e10),
        String("Microsoft.Media/mediaServices/assets/write"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "drm") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e6, 4e8),
        String("Microsoft.Media/mediaServices/streamingPolicies/drm/issue"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(3e8, 4e9),
      String("Microsoft.Media/mediaServices/liveEvents/liveOutputs/write"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateCommunicationServicesLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "call") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        props.durationSec * 1e9,
        "Microsoft.Communication/callDiagnostics/summary",
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "chat") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e6, 8e8),
        String(`Microsoft.Communication/chat/${props.operation}`),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "sms") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e8, 6e9),
        String("Microsoft.Communication/sms/outboundDelivery"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "email") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e7, 5e8),
        String("Microsoft.Communication/email/outbound/send"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "relay") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e8, 2e9),
        String("Microsoft.Communication/telephony/relay/connect"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(3e8, 2e9),
      String("Microsoft.Communication/meetings/participants/action"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateSignalRLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "conn") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e6, 2e8),
        String("Microsoft.SignalRService/SignalR/hub/connection"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "message") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e7, 2e9),
        String("Microsoft.SignalRService/SignalR/metrics/ingress"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "negotiate") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e5, 9e7),
        String("Microsoft.SignalRService/SignalR/negotiate"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "scale") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e9, 2e10),
        String("Microsoft.SignalRService/SignalR/scale/action"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "upstream") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e7, 4e8),
        String("Microsoft.SignalRService/SignalR/upstream/call"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 4e9),
      String("Microsoft.SignalRService/SignalR/write"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
...
export function generateNotificationHubsLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "push") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e7, 8e8),
        String("Microsoft.NotificationHubs/namespaces/notificationHubs/send"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "reg") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e6, 4e8),
        String(`Microsoft.NotificationHubs/registrations/${props.operation}`),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "telemetry") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e7, 9e8),
        String("Microsoft.NotificationHubs/namespaces/notificationHubs/telemetry"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "schedule") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e7, 6e8),
        String("Microsoft.NotificationHubs/namespaces/notificationHubs/schedule"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "installation") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e6, 3e8),
        String("Microsoft.NotificationHubs/installations/write"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 3e9),
      String("Microsoft.NotificationHubs/namespaces/write"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateAutomationAccountLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "runbook") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e9, 1.2e11),
        String("Microsoft.Automation/automationAccounts/runbooks/jobs/create"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "dsc") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e8, 3e10),
        String("Microsoft.Automation/automationAccounts/configurations/compile"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "webhook") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e7, 8e8),
        String("Microsoft.Automation/automationAccounts/webhooks/trigger"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "module") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e8, 6e10),
        String("Microsoft.Automation/automationAccounts/modules/write"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "inventory") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e9, 3e11),
        String("Microsoft.Automation/automationAccounts/softwareInventories/sync"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(6e9, 2e11),
      String("Microsoft.Automation/automationAccounts/softwareUpdateConfigurations/run"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateAppConfigurationLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "feature") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e7, 4e8),
        String("Microsoft.AppConfiguration/configurationStores/featureFlags/write"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "snapshot") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e8, 5e10),
        String("Microsoft.AppConfiguration/configurationStores/snapshots/write"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "replica") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e8, 2e10),
        String("Microsoft.AppConfiguration/configurationStores/replicas/status"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "sentinel") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e7, 2e8),
        String("Microsoft.AppConfiguration/configurationStores/events/sentinel"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 3e9),
      String("Microsoft.AppConfiguration/configurationStores/write"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateDeploymentEnvironmentsLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "catalog") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e8, 2e10),
        String("Microsoft.DevCenter/devcenters/catalogs/sync/action"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "pool") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e9, 2e11),
        String("Microsoft.DevCenter/projects/developerMachinePools/read"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "entitlement") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e8, 5e9),
        String("Microsoft.DevCenter/projects/entitlements/check"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "network") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e8, 8e9),
        String("Microsoft.DevCenter/projects/environments/network/diagnostic"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 5e9),
      String("Microsoft.DevCenter/projects/write"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateMapsLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "search") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e6, 4e8),
        String("Microsoft.Maps/search/searchAddress"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "route") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e7, 6e8),
        String("Microsoft.Maps/route/directions"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "render") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e7, 3e8),
        String("Microsoft.Maps/render/maptile"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "geocode") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e7, 4e9),
        String("Microsoft.Maps/search/geocode/batch"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "traffic") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e7, 5e8),
        String("Microsoft.Maps/traffic/flow/segment"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(8e6, 2e8),
      String("Microsoft.Maps/timezone/byCoordinates"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateBackupLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "job") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(6e9, 3e11),
        String("Microsoft.RecoveryServices/vaults/backupJobs/write"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "restore") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e9, 6e11),
        String("Microsoft.RecoveryServices/vaults/backupJobs/restore"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "policy") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e8, 4e9),
        String("Microsoft.RecoveryServices/vaults/backupPolicies/compliance/read"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "alert") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e8, 3e10),
        String("Microsoft.RecoveryServices/vaults/backupAlerts/fire"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "immutability") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e9, 2e11),
        String("Microsoft.RecoveryServices/vaults/backupSecurity/immutability"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(9e10, 4e11),
      String("Microsoft.RecoveryServices/vaults/backupJobs/geoCopy"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateSiteRecoveryLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "replication") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e7, 2e9),
        String("Microsoft.RecoveryServices/vaults/replicationHealth/read"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "failover") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(6e9, 4e11),
        String("Microsoft.RecoveryServices/vaults/replicationFabrics/failover/action"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "testRecovery") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e10, 3e11),
        String("Microsoft.RecoveryServices/vaults/replicationProtectedItems/testFailover"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "capacity") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e10, 3e11),
        String("Microsoft.RecoveryServices/vaults/capacity/report"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "drift") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e11, 6e11),
        String("Microsoft.RecoveryServices/vaults/replicationProviders/driftScan"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 5e9),
      String("Microsoft.RecoveryServices/vaults/write"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
...
export function generateMigrateLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "assess") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e9, 2e11),
        String("Microsoft.Migrate/assessmentProjects/assessments/evaluate"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "discover") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e8, 9e9),
        String("Microsoft.Migrate/assessmentProjects/discoveredMachines/read"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "replicate") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e9, 5e10),
        String("Microsoft.Migrate/replicationFabrics/replicationProtectionItems/read"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "dependencyMap") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e9, 3e11),
        String("Microsoft.Migrate/assessmentProjects/dependencyGroups/build"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "cutover") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e10, 9e11),
        String("Microsoft.Migrate/replicationFabrics/cutover/action"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(2e9, 8e10),
      String("Microsoft.Migrate/assessmentProjects/rightsizing/recommend"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateDataBoxLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "order") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e10, 6e11),
        String("Microsoft.DataBox/jobs/write"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "copy") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(6e9, 3e11),
        String("Microsoft.DataBox/jobs/copy/status"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "validate") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(7e9, 4e11),
        String("Microsoft.DataBox/jobs/validate/action"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "erase") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e11, 9e11),
        String("Microsoft.DataBox/jobs/erase/action"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "handoff") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e10, 4e11),
        String("Microsoft.DataBox/jobs/receiving/ack"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(8e10, 4e11),
      String("Microsoft.DataBox/jobs/shipping/update"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateDevcenterLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "devbox") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e9, 5e10),
        String("Microsoft.DevCenter/devcenters/devboxes/action"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "catalog") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e8, 2e10),
        String("Microsoft.DevCenter/devcenters/galleries/sync"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "quota") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e10, 2e11),
        String("Microsoft.DevCenter/devcenters/quotas/read"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "identities") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e11, 4e11),
        String("Microsoft.DevCenter/devcenters/access/identities/sync"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "connectivity") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e8, 9e10),
        String("Microsoft.DevCenter/devcenters/network/connectivity/read"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(2e8, 5e9),
      String("Microsoft.DevCenter/devcenters/write"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
...
export function generateLabServicesLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "provision") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(6e8, 2e10),
        String("Microsoft.LabServices/labPlans/labs/write"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "claim") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e8, 6e9),
        String("Microsoft.LabServices/labs/virtualMachines/action"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "image") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(9e10, 6e11),
        String("Microsoft.LabServices/labPlans/images/publish"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "schedule") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e8, 4e10),
        String("Microsoft.LabServices/labs/schedules/action"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "usage") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e10, 9e10),
        String("Microsoft.LabServices/labPlans/usage/read"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 4e9),
      String("Microsoft.LabServices/labPlans/write"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
...
export function generateLoadTestingLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "run") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        props.durationSec * 1e9,
        "Microsoft.LoadTestService/loadTests/testRuns/write",
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "artifact") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e8, 8e9),
        String("Microsoft.LoadTestService/loadTests/testFiles/validate"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "subnet") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(9e8, 7e10),
        String("Microsoft.LoadTestService/loadTests/network/validate"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "capacity") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(6e8, 9e9),
        String("Microsoft.LoadTestService/loadTests/limits/check"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 3e9),
      String("Microsoft.LoadTestService/loadTests/write"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
...
export function generatePipelineLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "run") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        props.totalDurationMin * 60e9,
        "Microsoft.DevOps/pipelines/runs/complete",
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "stage") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        props.durationSec * 1e9,
        "Microsoft.DevOps/pipelines/stages/complete",
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "approval") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e10, 5e11),
        String("Microsoft.DevOps/pipelines/approvals/complete"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "queue") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e11, 6e11),
        String("Microsoft.DevOps/pipelines/agents/queueDepth"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "check") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e9, 4e10),
        String("Microsoft.DevOps/pipelines/policyEvaluations/read"),
        ["process"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 4e9),
      String("Microsoft.DevOps/pipelines/write"),
      ["process"],
      isErr ? ["error"] : ["info"]
    ),
