...
export function generateAiFoundryLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "gateway") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e6, 3e9),
        String("AzureML.InferenceGateway/RequestAudit"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "fine_tune") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e8, 18e9),
        String("AzureML.FineTune/PipelineAudit"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "batch_inference") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e8, 24e9),
        String("AzureML.BatchInference/Execution"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(6e7, 14e9),
      String("Microsoft.MachineLearningServices/workspaces/deployments/write"),
      ["configuration"],
      isErr ? ["change"] : ["info"]
    ),
    message: isErr
...
export function generateDataExplorerLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "ingest") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e6, 6e9),
        String("ADX.DataIngest/BatchReceive"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "materialized_view") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e8, 12e9),
        String("ADX.MaterializedView/RefreshAudit"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "follower_database") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e8, 9e9),
        String("ADX.FollowerDatabase/SyncAudit"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(4e8, 11e9),
      String("Microsoft.Kusto/clusters/write"),
      ["configuration"],
      isErr ? ["change"] : ["info"]
    ),
    message: isErr
  ...
  if (variant === "session") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e6, 2e9),
        String("AVD.Connection/SessionBroker"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "host") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e6, 4e9),
        String("AVD.HostPool/HostRegistration"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "scaling_plan") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e6, 3e9),
        String("AVD.ScalingPlan/ScheduleEvaluation"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "application_group") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(6e7, 11e9),
        String("Microsoft.DesktopVirtualization/applicationGroups/write"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
...
export function generateElasticSanLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "volume") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(9e7, 12e9),
        String("ElasticSan.Volume/Provision"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "iscsi") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e6, 5e8),
        String("ElasticSan.Target/IOAudit"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "performance_tier_change") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(18e8, 30e9),
        String("ElasticSan.SkuChange/Execution"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "network_rule") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e7, 3e9),
        String("ElasticSan.Network/AccessPolicyAudit"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(4e8, 9e9),
      String("Microsoft.ElasticSan/elasticSans/write"),
      ["configuration"],
      isErr ? ["change"] : ["info"]
    ),
    message: isErr
  ...
  if (variant === "plugin_install") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e7, 5e9),
        String("Grafana.Plugin/Provisioning"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "data_source_test") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e7, 2e9),
        String("Grafana.DataSource/TestConnection"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "team_sync") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e6, 48e9),
        String("Grafana.IdP/TeamsSyncAudit"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "remote_write") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e6, 5e9),
        String("MonitorWorkspace.RemoteWrite/Ingest"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "query") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e6, 8e9),
        String("MonitorWorkspace.Query/Audit"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "scrape_config") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e7, 4e9),
        String("MonitorWorkspace.ScrapeConfig/Reload"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "alerting_rule") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e6, 6e9),
        String("MonitorWorkspace.Alerting/Evaluation"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "forward") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e6, 2e9),
        String("DnsResolver.Forwarding/Audit"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "conditional") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e5, 15e8),
        String("DnsResolver.RuleEngine/Match"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "inbound_health") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(9e6, 2e9),
        String("DnsResolver.InboundEndpoint/Health"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "vnet_integration") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e7, 8e9),
        String("DnsResolver.VirtualNetworkLink/SyncAudit"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "ingest") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e6, 4e9),
        String("ApplicationInsights/Ingestion"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "smart_detection") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e8, 5e9),
        String("ApplicationInsights/SmartDetection"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "workbook_export") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e9, 8e9),
        String("ApplicationInsights.Workbook/ExportAudit"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "network") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e6, 2e9),
        String("DedicatedHSM.Network/Health"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "partition_backup") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e9, 28e9),
        String("DedicatedHSM.Backup/PartitionExport"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "rbac_policy") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e8, 2e9),
        String("DedicatedHSM.RBAC/Evaluate"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "firmware_channel") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e9, 16e9),
        String("DedicatedHSM.Firmware/ChannelAudit"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "index") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1.2e7, 15e9),
        String("VideoIndexer.Index/Pipeline"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "live_stream") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e6, 42e9),
        String("VideoIndexer.Live/IngestTelemetry"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "transcription_export") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e7, 6e9),
        String("VideoIndexer.Transcript/Export"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "webhook_callback") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e8, 3e9),
        String("VideoIndexer.Webhook/DeliveryAudit"),
        ["configuration"],
        isErr ? ["change"] : ["info"]
      ),
      message: isErr
