  ...
  if (variant === "console") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e7, 2e9),
        String("Microsoft.App/containerApps/logStream/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "ingress") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e6, 5e8),
        String("Microsoft.App/containerApps/httpLogs/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "revision") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e8, 6e9),
        String("Microsoft.App/containerApps/revisions/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "dapr_sidecar") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e7, 4e8),
        String("Microsoft.App/containerApps/diagnostics/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
...
export function generateContainerInstancesLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "network_profile") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e8, 5e9),
        String("Microsoft.ContainerInstance/containerGroups/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "image_pull") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e7, 4e9),
        String("Microsoft.ContainerInstance/containerGroups/containers/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(5e7, 1e9),
      String("Microsoft.ContainerInstance/containerGroups/events/write"),
      ["host"],
      isErr ? ["error"] : ["info"]
    ),
  ...
  if (variant === "workload_placement") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e8, 6e9),
        String("Microsoft.ContainerService/fleets/workloads/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "hub_health") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e8, 2e9),
        String("Microsoft.ContainerService/fleets/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "auto_upgrade_profile") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e9, 8e9),
        String("Microsoft.ContainerService/fleets/autoUpgradeProfiles/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
...
export function generateAcrLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "geo_replicate") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e9, 9e9),
        String("Microsoft.ContainerRegistry/registries/replications/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "webhook_dispatch") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e8, 2e9),
        String("Microsoft.ContainerRegistry/registries/webhooks/events/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "task_agent") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e9, 4.5e10),
        String("Microsoft.ContainerRegistry/registries/runs/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e9, 6e9),
      String("Microsoft.ContainerRegistry/registries/importImage/action"),
      ["host"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateStaticWebAppsLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "staging_slot") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(6e8, 6e9),
        String("Microsoft.Web/staticSites/hostNameBindings/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "edge_fn") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e7, 4e8),
        String("Microsoft.Web/staticSites/functions/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "auth_redirect") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e8, 2e9),
        String("Microsoft.Web/staticSites/config/authsettings/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(2e8, 4e9),
      String("Microsoft.Web/staticSites/customDomains/write"),
      ["host"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateSpringAppsLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "runtime") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e6, 2e8),
        String("Microsoft.AppPlatform/Spring/apps/logStream/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "config_refresh") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e8, 4e9),
        String("Microsoft.AppPlatform/Spring/apps/refresh/action"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "svc_binding") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e8, 6e9),
        String("Microsoft.AppPlatform/Spring/apps/bindings/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "buildpack_diag") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e9, 4e10),
        String("Microsoft.AppPlatform/Spring/apps/build/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 1e9),
      String("Microsoft.AppPlatform/Spring/apps/metrics/write"),
      ["host"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateDedicatedHostLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "health") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e7, 8e8),
        String("Microsoft.Compute/hostGroups/hosts/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "host_binpack") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e7, 6e8),
        String("Microsoft.Compute/hostGroups/hosts/instanceView/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e9, 4e9),
      String("Microsoft.Compute/hostGroups/hosts/maintenance/schedule"),
      ["host"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateCapacityReservationLog(ts: string, er: number): EcsDocument {
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(2e8, 5e9),
      String("Microsoft.Compute/capacityReservationGroups/capacityReservations/write"),
      ["host"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateProximityPlacementLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "admin") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e8, 3e9),
        String("Microsoft.Compute/proximityPlacementGroups/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "colocation_audit") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e8, 12e8),
        String("Microsoft.Compute/proximityPlacementGroups/instanceView/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "zone_balance") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e7, 9e8),
        String("Microsoft.Compute/proximityPlacementGroups/virtualMachines/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "maintenance_eject") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e9, 8e9),
        String("Microsoft.Compute/proximityPlacementGroups/scheduledEvents/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 2e9),
      String("Microsoft.Compute/proximityPlacementGroups/virtualMachines/join/action"),
      ["host"],
      isErr ? ["error"] : ["info"]
    ),
...
export function generateComputeGalleryLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "publish") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e8, 2e10),
        String("Microsoft.Compute/galleries/images/versions/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "replica") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e8, 1.5e10),
        String("Microsoft.Compute/galleries/images/versions/replicate/action"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "signing_jws") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(8e8, 5e9),
        String("Microsoft.Compute/galleries/images/versions/startSigning/action"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "deprecation_schedule") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(6e8, 4e9),
        String("Microsoft.Compute/galleries/images/versions/endOfLife/action"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 4e9),
      String("Microsoft.Compute/galleries/write"),
      ["host"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
  ...
  if (variant === "attest") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e7, 2e9),
        String("Microsoft.Compute/virtualMachines/guestAttestationStatus/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "secureboot") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e7, 1e9),
        String("Microsoft.Compute/virtualMachines/instanceView/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "policy_audit") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e8, 2e9),
        String("Microsoft.PolicyInsights/policyTrackedResources/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "key_release") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e8, 4e9),
        String("Microsoft.Compute/virtualMachines/extensions/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
...
export function generateImageBuilderLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "run") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(6e9, 3.6e11),
        String("Microsoft.VirtualMachineImages/imageTemplates/run/action"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "customize") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e8, 5e9),
        String("Microsoft.VirtualMachineImages/imageTemplates/customize/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "distribute") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e9, 1.2e11),
        String("Microsoft.VirtualMachineImages/imageTemplates/distribute/action"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "validate_sources") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e8, 3e9),
        String("Microsoft.VirtualMachineImages/imageTemplates/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1e8, 3e9),
      String("Microsoft.VirtualMachineImages/imageTemplates/write"),
      ["host"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
  ...
  if (variant === "nsx") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e8, 4e9),
        String("Microsoft.AVS/privateClouds/workloadNetworks/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "hcx_extend") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e9, 1.2e10),
        String("Microsoft.AVS/privateClouds/hcxEnterpriseSites/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "srm_protect") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e9, 2e11),
        String("Microsoft.AVS/privateClouds/scriptExecutions/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
...
export function generateOracleOnAzureLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "provision") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(6e9, 4.32e11),
        String("Oracle.Database/cloudExadataInfrastructures/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "db") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(3e8, 9e9),
        String("Oracle.Database/cloudVmClusters/databases/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "cell_mesh") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e9, 8e10),
        String("Oracle.Database/cloudExadataInfrastructures/cells/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "rman_backup") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e11, 2e12),
        String("Oracle.Database/cloudVmClusters/backup/action"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
      message: isErr
  ...
  if (variant === "license_audit") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(4e10, 2e11),
        String("Oracle.Database/cloudVmClusters/licenseReports/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(1.2e10, 8.64e11),
      String("Oracle.Database/cloudExadataInfrastructures/maintenance/action"),
      ["host"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
...
export function generateSapOnAzureLog(ts: string, er: number): EcsDocument {
  ...
  if (variant === "transport_enqueue") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(2e9, 8e10),
        String("Microsoft.Workloads/sapApplicationServerInstances/extensionRequests/write"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "sapinst_trace") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(5e8, 3e11),
        String("Microsoft.Workloads/sapVirtualInstances/startInstallation/action"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  if (variant === "nw_http") {
    ...
    return {
      ...
      event: azureLogEvent(
        isErr,
        randInt(1e8, 2e10),
        String("Microsoft.Workloads/sapCentralServicesInstances/http/read"),
        ["host"],
        isErr ? ["error"] : ["info"]
      ),
  ...
  return {
    ...
    event: azureLogEvent(
      isErr,
      randInt(2e8, 2e9),
      String("Microsoft.Workloads/sapVirtualInstances/databaseInstances/read"),
      ["host"],
      isErr ? ["error"] : ["info"]
    ),
    message: isErr
