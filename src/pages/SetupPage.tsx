...
export function SetupPage({
  ...
  const SERVICE_CATEGORY: Record<string, ServiceCategory> = {
    ...
    lightsail: "Compute",
    cwsynthetics: "Management & Governance",
    ...
    bedrockguardrails: "AI & Machine Learning",
    ...
    acmpca: "Security & Identity",
    directoryservice: "Security & Identity",
    ...
    managedprometheus: "Management & Governance",
    mgn: "Management & Governance",
    ...
    ivs: "End User & Media",
    ivschat: "End User & Media",
    mediaconnect: "End User & Media",
    mediapackage: "End User & Media",
    mediastore: "End User & Media",
    mediatailor: "End User & Media",
    ses: "End User & Media",
    ...
    "application-insights": "Management & Governance",
    "automation-account": "Management & Governance",
    "app-configuration": "Management & Governance",
    "azure-backup": "Management & Governance",
    "deployment-environments": "Developer Tools",
    maps: "End User & Media",
    "managed-grafana": "Management & Governance",
    "managed-prometheus": "Management & Governance",
    ...
    "blockchain-node-engine": "Compute",
    ...
    "vertex-ai-agent-builder": "AI & Machine Learning",
    ...
    "colab-enterprise": "Developer Tools",
  ...
  const servicePackIndex = useMemo((): ServicePack[] => {
    ...
    const GENERIC_RULE_TAGS = new Set([
      "cloudloadgen",
      "aws",
      "gcp",
      "azure",
    ...
    for (const f of ALERT_RULE_FILES) {
      for (const r of f.rules) {
        const serviceTags = (r.tags ?? []).filter((t) => !GENERIC_RULE_TAGS.has(t));
        const serviceId = serviceTags[0] || r.tags?.find((t) => t !== "cloudloadgen") || f.group;
