...
const AWS_SERVICE_ICON_MAP = {
  ...
  mediapackage: "AWSElementalMediaLive",
  mediastore: "AWSElementalMediaLive",
  mediatailor: "AWSElementalMediaLive",
  ivs: "AWSElementalMediaLive",
  ivschat: "AmazonChimeSDK",
  cloudsearch: "AmazonOpenSearchService",
  directoryservice: "AWSIdentityandAccessManagement",
  acmpca: "AWSCertificateManager",
  mgn: "AWSMigrationHub",
  cwsynthetics: "AmazonCloudWatch",
  managedprometheus: "AmazonManagedGrafana",
