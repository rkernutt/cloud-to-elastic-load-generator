...
export function genericVendorBulkIndex(indexPrefix: string, dataset: string, vendor: CloudId): string {
...
export function genericVendorDocDataset(indexPrefix: string, __dataset: string, vendor: CloudId): string {
