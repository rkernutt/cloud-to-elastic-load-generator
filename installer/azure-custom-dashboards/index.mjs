#!/usr/bin/env node
/**
 * Azure → Elastic Custom Dashboard Installer
 *
 * Kibana dashboards (ES|QL over logs-azure.*) for the Azure load generator.
 *
 * Run:  node index.mjs  |  npm run setup:azure-dashboards
 */
...
function printHeader() {
  console.log("");
  console.log("╔══════════════════════════════════════════════════════╗");
  console.log("║     Azure → Elastic Custom Dashboard Installer      ║");
  console.log("╚══════════════════════════════════════════════════════╝");
  console.log("");
  console.log("Installs Kibana dashboards for Azure services (logs-azure.*).");
  console.log("");
}
...
async function main() {
  ...
  console.log("\nChecking data views...");
  const DATA_VIEWS = [
    { title: "logs-azure.*", name: "Azure logs (load generator)" },
  ...
  if (failedCount > 0) {
    console.log(
      "\nIf the error above mentions 'not available with the current configuration',\n" +
        ...
        "and add ndjson exports for this directory if needed."
    );
  }
