...
export const PIPELINE_REGISTRY = [
  {
    ...
    group: "security",
    description:
      "Parse JSON from message field for gcp.accesscontextmanager (service access-context-manager)",
  ...
  },
  {
    ...
    group: "management",
    description:
      "Parse JSON from message field for gcp.accesstransparency (service access-transparency)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "integration",
    description:
      "Parse JSON from message field for gcp.appintegration (service application-integration)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
    ...
    group: "containers",
    description:
      "Parse JSON from message field for gcp.artifactregistry (service artifact-registry)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
    ...
    group: "security",
    description:
      "Parse JSON from message field for gcp.assuredworkloads (service assured-workloads)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "security",
    description:
      "Parse JSON from message field for gcp.binaryauthorization (service binary-authorization)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "compute",
    description:
      "Parse JSON from message field for gcp.compute_sole_tenant (service sole-tenant-nodes)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "compute",
    description:
      "Parse JSON from message field for gcp.confidential_computing (service confidential-computing)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "containers",
    description:
      "Parse JSON from message field for gcp.containerregistry (service container-registry)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "management",
    description:
      "Parse JSON from message field for gcp.deploymentmanager (service deployment-manager)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "management",
    description:
      "Parse JSON from message field for gcp.essentialcontacts (service essential-contacts)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "aiml",
    description:
      "Parse JSON from message field for gcp.featurestore (service vertex-ai-feature-store)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "devtools",
    description:
      "Parse JSON from message field for gcp.gemini_code_assist (service gemini-code-assist)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "integration",
    description:
      "Parse JSON from message field for gcp.integration_connectors (service integration-connectors)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "aiml",
    description:
      "Parse JSON from message field for gcp.matching_engine (service vertex-ai-matching-engine)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "containers",
    description:
      "Parse JSON from message field for gcp.migrate_containers (service migrate-to-containers)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "aiml",
    description:
      "Parse JSON from message field for gcp.recommendations (service recommendations-ai)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "management",
    description:
      "Parse JSON from message field for gcp.servicedirectory (service service-directory)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "aiml",
    description:
      "Parse JSON from message field for gcp.tensorboard (service vertex-ai-tensorboard)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "aiml",
    description:
      "Parse JSON from message field for gcp.vertexai_pipelines (service vertex-ai-pipelines)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "media",
    description:
      "Parse JSON from message field for gcp.videointelligence (service video-intelligence)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
  ...
  },
  {
    ...
    group: "security",
    description:
      "Parse JSON from message field for gcp.websecurityscanner (service web-security-scanner)",
    processors: [{ json: { field: "message", target_field: "gcp.parsed", ignore_failure: true } }],
  },
  {
