#!/usr/bin/env node
/**
 * GCP → Elastic ML Anomaly Detection Jobs Installer
 *
 * Interactive CLI that installs Elasticsearch ML anomaly detection jobs
 * targeting logs-gcp.* data from the GCP load generator.
 *
 * Run with:  node installer/gcp-custom-ml-jobs/index.mjs
 *            npm run setup:gcp-ml-jobs
 *
...
function printHeader() {
  console.log("");
  console.log("╔══════════════════════════════════════════════════════╗");
  console.log("║     GCP → Elastic ML Anomaly Detection Installer       ║");
  console.log("╚══════════════════════════════════════════════════════╝");
  console.log("");
  console.log("Manages Elasticsearch ML anomaly detection jobs for GCP logs.");
