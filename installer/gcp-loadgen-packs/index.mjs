#!/usr/bin/env node
/**
 * GCP loadgen integration packs — install ingest pipeline, Kibana dashboard, and ML jobs
 * for one or more services in a single flow.
 *
 * Run: node installer/gcp-loadgen-packs/index.mjs
 *      npm run setup:gcp-loadgen-packs
 */

import readline from "readline";
import { createElasticClient as createEsPipelineClient } from "../gcp-custom-pipelines/elastic.mjs";
import { createElasticClient as createMlClient } from "../gcp-custom-ml-jobs/mlClient.mjs";
import {
  createKibanaClient,
  installOne as installDashboardOne,
} from "../gcp-custom-dashboards/installLib.mjs";
...
function printHeader() {
  console.log("");
  console.log("╔════════════════════════════════════════════════════════════╗");
  console.log("║   GCP loadgen integration packs (pipeline + dash + ML)    ║");
  console.log("╚════════════════════════════════════════════════════════════╝");
  console.log("");
 ...
 * metrics-gcp.* indices with proper dimension and metric field routing.
 */
