#!/usr/bin/env node
/**
 * Azure → Elastic Custom Pipeline Installer
 *
 * Installs Elasticsearch ingest pipelines for logs-azure.* data streams
 * (Azure Elastic Load Generator).
 *
 * Run:  node index.mjs  |  npm run setup:azure-pipelines
 *
 * Registry: scripts/generate-azure-pipeline-registry.mjs
 *
...
function printHeader() {
  console.log("");
  console.log("╔══════════════════════════════════════════════════════╗");
  console.log("║     Azure → Elastic Custom Pipeline Installer        ║");
  console.log("╚══════════════════════════════════════════════════════╝");
  console.log("");
  console.log("Installs ingest pipelines for logs-azure.* data streams.");
  console.log("");
}
