#!/usr/bin/env node
/**
 * Azure loadgen integration packs — install ingest pipeline, Kibana dashboard, and ML jobs
 * for one or more services in a single flow.
 *
 * Run: node installer/azure-loadgen-packs/index.mjs
 *      npm run setup:azure-loadgen-packs
 */

import readline from "readline";
import { createElasticClient as createEsPipelineClient } from "../azure-custom-pipelines/elastic.mjs";
...
function printHeader() {
  console.log("");
  console.log("╔════════════════════════════════════════════════════════════╗");
  console.log("║  Azure loadgen integration packs (pipeline + dash + ML)   ║");
  console.log("╚════════════════════════════════════════════════════════════╝");
  console.log("");
