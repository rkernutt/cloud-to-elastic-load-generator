...
| [SETUP-WIZARD-AND-UNINSTALL.md](./SETUP-WIZARD-AND-UNINSTALL.md) | Web UI Setup: filters, **AWS service-type grouping** for dashboards & ML, Align with Services, persistence; **dashboard uninstall limits on Serverless** |
